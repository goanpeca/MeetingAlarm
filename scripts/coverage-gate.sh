...
EXCLUDE="${EXCLUDE:-App.swift Logging.swift Keychain.swift SoundPlayer.swift OverlayController.swift OverlayView.swift EventKitSource.swift GoogleCalendarSource.swift GoogleAuth.swift LoopbackServer.swift AlarmScheduler.swift AppCoordinator.swift AppCoordinator+Sources.swift MenuContentView.swift SettingsView.swift AccountsView.swift}"
