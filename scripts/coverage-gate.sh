...
EXCLUDE="${EXCLUDE:-App.swift Logging.swift Keychain.swift SoundPlayer.swift OverlayController.swift OverlayView.swift ChallengeGateView.swift NotesView.swift MeetingProvider.swift EventKitSource.swift GoogleCalendarSource.swift GoogleAuth.swift LoopbackServer.swift AlarmScheduler.swift AppCoordinator.swift AppCoordinator+Sources.swift AppCoordinator+UI.swift MenuContentView.swift SettingsView.swift}"
