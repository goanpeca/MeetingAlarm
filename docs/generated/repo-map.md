...
| `Sources/MeetingAlarm/Alarm/ChallengeGateView.swift` | The dismiss puzzle (math / type-phrase) gate view. |
...
| `Sources/MeetingAlarm/AppCoordinator+Sources.swift` | Calendar-visibility filter actions. |
